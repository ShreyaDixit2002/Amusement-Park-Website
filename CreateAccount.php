...
if(isset($_POST['FName'])){
    ...
    if($usercount>0){
        ...
        if($Pass === $CPass){
            ...
            $sql2="CREATE TABLE `banking`.`$TransactionTable` ( `Sno` INT NOT NULL AUTO_INCREMENT, `Transfer_to` VARCHAR(255) NOT NULL , `Transfer_from` VARCHAR(255) NOT NULL , `Mode`, `Date` DATE NOT NULL , `Amount` DOUBLE NOT NULL , `Bal` DOUBLE NOT NULL, PRIMARY KEY (`Sno`));";
